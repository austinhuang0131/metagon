**Metagon is no longer maintained. The bot will be kept running, but no bug fixes or new features will be implemented.** The bot is [open source](https://github.com/austinhuang0131/metagon), and I will cooperate if a maintainer comes up, but for now I am no longer interested in maintaining Metagon. The bot is also no longer available on Slack due to regulatory changes.
